...
class RenderSystem {
	...
	const std::array<std::string, texture_count> texture_paths = {
			...
			textures_path("levelFour1.png"),
			textures_path("levelFour2.png"),
			textures_path("levelFour3.png"),
			textures_path("levelFour4.png"),
			textures_path("levelFour5.png"),
			textures_path("levelFour6.png"),
			textures_path("levelFour7.png"),
			textures_path("levelFour8.png"),
			textures_path("levelFiveRec1.png"),
			textures_path("levelFiveRec2.png"),
			textures_path("levelFiveRec3.png"),
			textures_path("levelFiveRec4.png"),
			textures_path("levelFiveRec5.png"),
			textures_path("levelFiveRec6.png"),
			textures_path("levelFiveRec7.png"),
			textures_path("levelFiveRec8.png"),
			textures_path("levelFiveRec9.png"),
			textures_path("levelFive1.png"),
			textures_path("levelFive2.png"),
			textures_path("levelFive3.png"),
			textures_path("levelFive4.png"),
			textures_path("levelFive5.png"),
			textures_path("levelFive6.png"),
			...
			textures_path("levelFinal1.png"),
			textures_path("levelFinal2.png"),
			textures_path("levelFinal3.png"),
			textures_path("levelFinal4.png"),
			textures_path("levelFinal5.png"),
			textures_path("levelFinal6.png"),
